// Inline icon set for the digital business card (no brand icons in lucide-react).
...
export function WazeIcon({ size = 22 }: { size?: number }) {
  // Generic navigation arrow (Waze's logo is trademarked; a nav glyph reads clearly)
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function SaveContactIcon({ size = 22 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" />
      <circle cx="12" cy="7" r="4" />
      <path d="M19 8v6M22 11h-6" strokeWidth="2.2" />
    </svg>
  );
}
