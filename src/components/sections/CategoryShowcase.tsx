...
const CATEGORIES: Category[] = [
  {
    ...
    label: 'טורבינות',
    labelEn: 'Turbines',
    desc: 'טורבינות אוויר במהירות גבוהה — NSK, W&H, KaVo, Bien-Air',
    count: '778',
    image: '/images/categories/turbines.jpg',
    wide: true,
  },
  {
    slug: 'angles',
    ...
    count: '412',
    image: '/images/categories/angles.jpg',
  },
  {
    slug: 'handpieces',
    label: 'ידיתנים',
    ...
    count: '324',
    image: '/images/categories/handpieces.jpg',
  },
  {
    slug: 'drills',
    label: 'מקדחים',
