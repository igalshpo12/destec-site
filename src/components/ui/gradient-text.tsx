...
// framer-motion@12 is the Motion library (same as the `motion` package / `motion/react`),
// already a project dependency — used here to avoid a duplicate animation lib.
