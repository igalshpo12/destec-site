...
- Name: e2e.spec.ts >> Catalog — category pages >> prophylaxis — loads Hebrew label and products
...
Call log:
  ...
  - waiting for locator('body')
    - locator resolved to <body class="@container">…</body>
  ...
  Continue with GitHubContinue with AppleContinue with SAML SSOContinue with PasskeyShow other optionsDon't have an account? Sign UpTermsPrivacy PolicyLog in to VercelContinue with Email
  ...
  Continue with GitHubContinue with AppleContinue with SAML SSOContinue with PasskeyShow other optionsDon't have an account? Sign UpTermsPrivacy PolicySign UpLogin – Vercel"
    22 × locator resolved to <body class="@container">…</body>
       - unexpected value "Skip to contentSign UpLog in to VercelContinue with Email
...
- banner:
  ...
  - navigation:
    - navigation:
      - link "Sign Up":
        - /url: /signup?next=%2Fsso-api%3Furl%3Dhttps%253A%252F%252Fdestec-site-ixygc3oow-des-manager.vercel.app%252Fcatalog%253Fcategory%253Dprophylaxis%26nonce%3D546d951664ecd27daa1e231c3f292848407fb87524e27ba0db2ed6f2a0c2657c
        - paragraph: Sign Up
- main:
