...
- Name: e2e.spec.ts >> Homepage >> all 7 nav categories present
- Location: tests/e2e.spec.ts:13:7
...
Call log:
  ...
  - waiting for locator('body')
    ...
    - unexpected value "Skip to contentLog in to VercelContinue with Email
...
- banner:
  ...
  - navigation:
    - navigation:
      - link "Sign Up":
        - /url: /signup?next=%2Fsso-api%3Furl%3Dhttps%253A%252F%252Fdestec-site-ixygc3oow-des-manager.vercel.app%252F%26nonce%3Dd58141cc7493d1dffc7a5ec81bac806f87870397feeb08d0c0b45c5ae7568faf
        - paragraph: Sign Up
- main:
