...
- Name: e2e.spec.ts >> Catalog — search >> searching NSK returns relevant products
- Location: tests/e2e.spec.ts:75:7
...
Call log:
  - waiting for locator('input[type="search"], input[placeholder*="חיפוש"], input[placeholder*="search" i]').first()
      ...
      - navigation [ref=e5]:
        - navigation [ref=e6]:
          - link "Sign Up" [ref=e7] [cursor=pointer]:
            - /url: /signup?next=%2Fsso-api%3Furl%3Dhttps%253A%252F%252Fdestec-site-ixygc3oow-des-manager.vercel.app%252Fcatalog%26nonce%3Dd30d48854501236969cce0a27fc51df0f0ac635e1a33369db3a6b66e6b02feb2
