...
- Name: e2e.spec.ts >> Contact page >> loads with WhatsApp link and form fields
- Location: tests/e2e.spec.ts:86:7
...
Call log:
  ...
  - waiting for locator('body')
    14 × locator resolved to <body class="@container">…</body>
...
- banner:
  ...
  - navigation:
    - navigation:
      - link "Sign Up":
        - /url: /signup?next=%2Fsso-api%3Furl%3Dhttps%253A%252F%252Fdestec-site-ixygc3oow-des-manager.vercel.app%252Fcontact%26nonce%3D4e506015e4d5244293b17a10302fdfeaab20b2331aa7c5660df807bb71b4af87
        - paragraph: Sign Up
- main:
