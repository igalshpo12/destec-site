...
- Name: e2e.spec.ts >> Catalog — category pages >> restorative — loads Hebrew label and products
...
Call log:
  ...
  - waiting for locator('body')
    24 × locator resolved to <body class="@container">…</body>
...
- banner:
  ...
  - navigation:
    - navigation:
      - link "Sign Up":
        - /url: /signup?next=%2Fsso-api%3Furl%3Dhttps%253A%252F%252Fdestec-site-ixygc3oow-des-manager.vercel.app%252Fcatalog%253Fcategory%253Drestorative%26nonce%3D3e2fa563788a9f811a63ed48131805074cb01887abcbf35ba54fffb301df465a
        - paragraph: Sign Up
- main:
